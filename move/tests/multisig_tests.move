...
module multisig::multisig_unit_tests {
    ...
    fun test_derive_multisig_address() {
        // ED25519
        let address1: address = @0x73a6b3c33e2d63383de5c6786cbaca231ff789f4c853af6d54cb883d8780adc0;
        ...
        assert!(ms::ed25519_key_to_address(&key1) == address1, 0);

        // Secp256k1
        let address2: address = @0xd9607cd03428c904949572b51471e7a9f60019aeb9a3d7ee5e72921cab8e8be7;
        ...
        assert!(ms::secp256k1_key_to_address(&key2) == address2, 0);

        // Secp256r1
        let address3: address = @0x600b1081644fe46f76da3bdc19f8743b9f04458516364374c7d82959e790c19e;
        ...
        assert!(ms::secp256r1_key_to_address(&key3) == address3, 0);
