...
module multisig::multisig_unit_tests {
    ...
    fun test_derive_multisig_address() {
        ...
        assert!(ms::ed25519_key_to_address(&key1) == _address1, 0);
        ...
        assert!(ms::secp256k1_key_to_address(&key2) == _address2, 0);
        ...
        assert!(ms::secp256r1_key_to_address(&key3) == _address3, 0);
